...
import com.easierphone.storaageapp.misc.ImageUtils;
import com.easierphone.storaageapp.misc.OsCompat;
import com.easierphone.storaageapp.misc.Utils;
import com.easierphone.storaageapp.provider.DocumentsProvider;
import com.easierphone.storaageapp.provider.UsbStorageProvider;
...
import static com.easierphone.storaageapp.misc.SAFManager.DOCUMENT_AUTHORITY;
...
public final class DocumentsContract {
     ...
     */
    public static final String PROVIDER_INTERFACE = "com.easierphone.storaageapp.action.DOCUMENTS_PROVIDER";
     ...
     * {@link com.easierphone.storaageapp.model.DocumentsContract.Document#COLUMN_DOCUMENT_ID}.
     *
    ...
    /**
     * Build URI representing the target {@link com.easierphone.storaageapp.model.DocumentsContract.Document#COLUMN_DOCUMENT_ID} in
     * a document provider. When queried, a provider will return a single row
     * with columns defined by {@link com.easierphone.storaageapp.model.DocumentsContract.Document}.
     *
     ...
     * Build URI representing the children of the target directory in a document
     * provider. When queried, a provider will return zero or more rows with
     * columns defined by {@link com.easierphone.storaageapp.model.DocumentsContract.Document}.
     * <p>
     ...
     *            directory with MIME type of {@link com.easierphone.storaageapp.model.DocumentsContract.Document#MIME_TYPE_DIR}.
     * @see android.content.Intent#ACTION_OPEN_DOCUMENT_TREE
     * @see android.provider.DocumentsProvider#isChildDocument(String, String)
    ...
    /**
     * Extract the {@link com.easierphone.storaageapp.model.DocumentsContract.Document#COLUMN_DOCUMENT_ID} from the given URI.
     *
    ...
    /**
     * Extract the via {@link com.easierphone.storaageapp.model.DocumentsContract.Document#COLUMN_DOCUMENT_ID} from the given URI.
     */
