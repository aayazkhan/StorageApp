...
import com.easierphone.storaageapp.provider.DownloadStorageProvider;
...
import com.easierphone.storaageapp.provider.NonMediaDocumentsProvider;
import com.easierphone.storaageapp.provider.RecentsProvider;
import com.easierphone.storaageapp.provider.RootedStorageProvider;
...
import static com.easierphone.storaageapp.model.DocumentInfo.getCursorLong;
...
/*    public boolean isHome() {
    ...
    public static boolean isTools(RootInfo root) {
        return root.isConnections() || root.isRootedStorage();
    }

    public static boolean isOtherRoot(RootInfo root) {
        return null != root && (root.isHome() || root.isConnections());
    }
