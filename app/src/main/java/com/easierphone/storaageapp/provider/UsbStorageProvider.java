...
import com.easierphone.storaageapp.usb.UsbUtils;
...
import static com.easierphone.storaageapp.misc.FileUtils.getTypeForName;
import static com.easierphone.storaageapp.misc.MimeTypes.BASIC_MIME_TYPE;
...
public class UsbStorageProvider extends DocumentsProvider {
     ...
     */
    private static final String ACTION_USB_PERMISSION = "com.easierphone.storaageapp.action.USB_PERMISSION";
