...
import com.easierphone.storageapp.misc.ImageUtils;
import com.easierphone.storageapp.misc.OsCompat;
import com.easierphone.storageapp.misc.Utils;
import com.easierphone.storageapp.provider.DocumentsProvider;
import com.easierphone.storageapp.provider.UsbStorageProvider;
...
import static com.easierphone.storageapp.misc.SAFManager.DOCUMENT_AUTHORITY;
...
public final class DocumentsContract {
     ...
     */
    public static final String PROVIDER_INTERFACE = "com.easierphone.storageapp.action.DOCUMENTS_PROVIDER";
     ...
     * {@link com.easierphone.storageapp.model.DocumentsContract.Document#COLUMN_DOCUMENT_ID}.
     *
    ...
    /**
     * Build URI representing the target {@link com.easierphone.storageapp.model.DocumentsContract.Document#COLUMN_DOCUMENT_ID} in
     * a document provider. When queried, a provider will return a single row
     * with columns defined by {@link com.easierphone.storageapp.model.DocumentsContract.Document}.
     *
     ...
     * Build URI representing the children of the target directory in a document
     * provider. When queried, a provider will return zero or more rows with
     * columns defined by {@link com.easierphone.storageapp.model.DocumentsContract.Document}.
     * <p>
     ...
     *            directory with MIME type of {@link com.easierphone.storageapp.model.DocumentsContract.Document#MIME_TYPE_DIR}.
     * @see android.content.Intent#ACTION_OPEN_DOCUMENT_TREE
     * @see android.provider.DocumentsProvider#isChildDocument(String, String)
    ...
    /**
     * Extract the {@link com.easierphone.storageapp.model.DocumentsContract.Document#COLUMN_DOCUMENT_ID} from the given URI.
     *
    ...
    /**
     * Extract the via {@link com.easierphone.storageapp.model.DocumentsContract.Document#COLUMN_DOCUMENT_ID} from the given URI.
     */
