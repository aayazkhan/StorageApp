...
import static com.easierphone.storageapp.misc.DiskInfo.FLAG_SD;
import static com.easierphone.storageapp.misc.DiskInfo.FLAG_USB;
...
public final class StorageUtils {
    ...
    public List<StorageVolume> getStorageMounts() {
        ...
        for (Object object : sv) {
            if (Utils.hasOreoMR1()) {
                if (object instanceof android.os.storage.StorageVolume) {
                    android.os.storage.StorageVolume storage = (android.os.storage.StorageVolume) object;
                    ...
                    boolean mEmulated = storage.isEmulated();
                    boolean mRemovable = storage.isRemovable();
