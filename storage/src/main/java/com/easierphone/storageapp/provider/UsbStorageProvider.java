...
import com.easierphone.storageapp.usb.UsbUtils;
...
import static com.easierphone.storageapp.misc.FileUtils.getTypeForName;
import static com.easierphone.storageapp.misc.MimeTypes.BASIC_MIME_TYPE;
...
public class UsbStorageProvider extends DocumentsProvider {
     ...
     */
    private static final String ACTION_USB_PERMISSION = "com.easierphone.storageapp.action.USB_PERMISSION";
